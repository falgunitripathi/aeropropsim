...
<ul>
  ...
  <li>See the in-app Assumptions panel and the project README for the full list of documented simplifications and judgment calls.</li>
</ul>

<p class="note">Generated by ThrustForge — all physics runs client-side, ported from the validated aeropropsim engineering core.</p>
</body>
</html>`;
}
